...
function getDefaultConfig() {
    return { "date": getTodayDate(), "numPosition": "", "hasPrint": "1", "hasBuy": "0", "device": "0", "color": "0", "type": "0", "hasParents": "0", "hasTests": "0", "timer": "10", "buy": false, "textColor":0 };
}
...
function getTexts() {
    return [{"name":"!הבאת היום את החוברת, קראת ומלאת יחד, זכית בחמישים נקודות","points":50,"code":510000001}, {"name":"!למדת אתמול את המשניות בעל פה, במאה נקודות נוספות זכית","points":100,"code":510000002}, {"name":"!אתמול חזרת בחברותא, במאה חמישים נקודות נוספות זכית","points":50,"code":510000003}];
}